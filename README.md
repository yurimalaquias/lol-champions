...
## Sobre o Projeto
Mais informações no sobre os Bootcamps e Conteudos DIO
Repo: **[Satander Dev Week](https://github.com/digitalinnovationone/santander-dev-week-2024)**

Neste repositório, você encontrará o código-fonte de uma REST API (pasta `/backend`) e seu respectivo Frontend (pasta `/frontend`).
Este projeto, construído com Java 21 e Spring Boot 3, é o resultado de quatro dias de lives, com um propósito singular:
